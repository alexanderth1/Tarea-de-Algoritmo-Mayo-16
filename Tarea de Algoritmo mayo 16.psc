...
Funcion ejercicio5
	...
	SiNo
		si num1 < num2 Entonces
			Escribir "El primer numero es menor que el segundo su valor"
		SiNo
			Escribir "El segundo numero es menor que el segun su valor"
		FinSi
	FinSi
...
Funcion ejercicio8
	...
	si cantidad >= 1000 entonces 
		escribir " Se le cobrara un $1 dolara por cada lapiz"
		cantidad= cantidad * precio1
		escribir " El total a pagar es: " cantidad " $"
		sino 
			si cantidad < 1000 
			escribir "Se le cobrara $1.50 por cada lapiz"
...
funcion ejercicio10
	...
	si cantidad <= 200 Entonces
		...
		Escribir "El total a pagar por las ",cantidad," cantidad es ",preciofinal," $"
	SiNo
		si cantidad >= 200 y cantidad <= 300 Entonces
			preciofinal = cantidad * precio2
			Escribir "El precio por persona es: ",precio2
			Escribir "El total a pagar por las ",cantidad," persona es ",preciofinal, " $"
		SiNo
...
Funcion ejercicio18
	...
	Escribir "---------------------------"
	Escribir "Banco Guayaquil      - 1"
	Escribir "Banco Pichincha      - 2"
	Escribir "Banco Del Austro     - 3"
	Escribir "Banco Del Pacifico   - 4"
	Escribir "Produbanco           - 5"
	Escribir "---------------------------"
	leer tipo
